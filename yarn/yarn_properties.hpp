...
struct YarnProperties {
    // Core dimension
    float relaxed_radius = 1.75f;                 // Half diameter when relaxed (mm)
    float compressed_radius = 0.75f;              // Half diameter when compressed in fabric (mm)

    // Bending constraints
    float min_bend_radius = 2.25f;    // Minimum bend radius (typically 3x compressed_radius)
    ...
    static YarnProperties fingering() {
        return YarnProperties{
            .relaxed_radius = 0.75f,
            .compressed_radius = 0.35f,
            .min_bend_radius = 1.05f,
            .loop_slack = 0.08f,
            .stiffness = 0.4f,
            .friction = 0.3f
        };
    ...
    static YarnProperties worsted() {
        return YarnProperties{
            .relaxed_radius = 1.75f,
            .compressed_radius = 0.75f,
            .min_bend_radius = 2.25f,
            .loop_slack = 0.1f,
            .stiffness = 0.5f,
            .friction = 0.3f
        };
    ...
    static YarnProperties bulky() {
        return YarnProperties{
            .relaxed_radius = 3.0f,
            .compressed_radius = 1.25f,
            .min_bend_radius = 3.75f,
            .loop_slack = 0.12f,
            .stiffness = 0.6f,
            .friction = 0.35f
        };
